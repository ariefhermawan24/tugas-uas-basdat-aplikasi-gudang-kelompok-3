<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
    ...
    {{-- TITLE + BREADCRUMB --}}
    <div class="w-100">
        <h4 class="fw-semibold mb-1">Pesanan Kadaluarsa</h4>
                        ...
                        <td>
                            @php
                                $statusColor = match ($order->status) {
                                    'checking'  => 'info',        // sedang diverifikasi
                                    'pending'   => 'warning',     // menunggu tindakan
                                    'approved'  => 'success',     // disetujui
                                    'rejected'  => 'danger',      // ditolak
                                    'upcoming'  => 'primary',     // akan datang / terjadwal
                                    'stored'    => 'success',     // sudah tersimpan di gudang
                                    'outgoing'  => 'dark',        // barang keluar
                                    'due'       => 'warning',     // hampir kedaluwarsa
                                    'expired'   => 'secondary',  // kedaluwarsa
                                    'canceled'  => 'danger',      // dibatalkan
                                    default     => 'secondary',
                                };
                            @endphp
