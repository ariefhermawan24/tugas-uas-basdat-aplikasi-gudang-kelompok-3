...
<body data-active-module="{{ $module ?? 'dashboard' }}">
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-item">
                <a class="nav-link menu-parent {{ str_starts_with($module ?? '', 'orders') ? 'active' : '' }}" href="#" data-menu="order-management">
                ...
                <div class="submenu">
                    <a class="nav-link submenu-item {{ ($module ?? '') === 'orders_details' ? 'active' : '' }}"
                        href="{{ route('admin', 'orders_details') }}"
                        data-parent="order-management"
                        style="--index: 0">
                        <i class="far fa-list-alt"></i>
                        <span>Order Details</span>
                    </a>
                    <a class="nav-link submenu-item {{ ($module ?? '') === 'orders_validation' ? 'active' : '' }}" href="{{ route('admin', 'orders_validation') }}" data-parent="order-management" style="--index: 1">
            ...
            <div class="menu-item">
                <a class="nav-link menu-parent {{ str_starts_with($module ?? '', 'upcoming_') || str_starts_with($module ?? '', 'outgoing_') ? 'active' : '' }}"
                    href="#"
                    data-menu="inventory">
                ...
                <div class="submenu">
                    <a class="nav-link submenu-item {{ ($module ?? '') === 'upcoming_goods' ? 'active' : '' }}"
                        href="{{ route('admin', 'upcoming_goods') }}"
                        data-parent="inventory"
                        style="--index:0">
                        <i class="fas fa-truck-loading"></i>
                        <span>Upcoming Goods</span>
                    </a>

                    <a class="nav-link submenu-item {{ ($module ?? '') === 'outgoing_goods' ? 'active' : '' }}"
                        href="{{ route('admin', 'outgoing_goods') }}"
                        data-parent="inventory"
                        style="--index:1">
            ...
            <div class="menu-item">
                <a class="nav-link menu-parent {{ in_array($module ?? '', ['active_orders','due_orders','expired_orders']) ? 'active' : '' }}"
                    href="#"
                ...
                <div class="submenu">
                    ...
                    <a class="nav-link submenu-item {{ ($module ?? '') === 'expired_orders' ? 'active' : '' }}"
                        href="{{ route('admin', 'expired_orders') }}"
                        data-parent="monitoring"
                        style="--index:2">
            ...
            <div class="menu-item">
                <a class="nav-link menu-parent {{ str_starts_with($module ?? '', 'user_') ? 'active' : '' }}"
                    href="#"
                ...
                <div class="submenu">
                    <a class="nav-link submenu-item {{ ($module ?? '') === 'user_list' ? 'active' : '' }}"
                        href="{{ route('admin', 'user_list') }}"
                        data-parent="user-management"
                        style="--index:0">
                        <i class="fas fa-list"></i>
                        <span>User List</span>
                    </a>

                    <a class="nav-link submenu-item {{ ($module ?? '') === 'user_status' ? 'active' : '' }}"
                        href="{{ route('admin', 'user_status') }}"
                        data-parent="user-management"
                        style="--index:1">
    ...
    <main class="main-content" id="mainContent">
        @include('admin.modul.' . ($module ?? 'dashboard'))
    </main>
